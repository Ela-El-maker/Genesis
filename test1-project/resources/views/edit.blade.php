            ...
            <div class="card-body">
                <form action="{{route('posts.update', $post->id)}}" method="POST" enctype="multipart/form-data" class="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image" class="form-control" id="" value="{{$post->image}}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="" cols="30" rows="10" class="form-control" value="{{$post->description}}" >{{$post->description}}</textarea>
                    </div>
